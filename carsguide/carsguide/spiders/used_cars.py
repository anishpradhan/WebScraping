...
class UsedCars(scrapy.Spider):
    ...
    def start_requests(self):
        url = "https://www.carsguide.com.au/buy-a-car/all-used/all-states/all-locations/all-bodytypes/all-makes/?sortBy=make%2Cmodel&orderBy=asc&searchOffset=60552&searchLimit=12"
